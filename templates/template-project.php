...
<body>
    ...
    <table class="items-table">
        <thead>
            <tr>
                <th><?php echo esc_html__('Project Description', 'ipsit-invoice-generator'); ?></th>
                <th class="text-right"><?php echo esc_html__('Project Price', 'ipsit-invoice-generator'); ?></th>
                <th class="text-right"><?php echo esc_html__('Project Amount', 'ipsit-invoice-generator'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($items as $item): ?>
                <?php
                // For project-based invoices, price is the amount (no quantity)
